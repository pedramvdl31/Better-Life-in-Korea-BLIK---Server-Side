    ...
    <body>
        <header id="header"><!--header-->
            ...
            <div id="tab-holder" class="text-center col-md-12 col-xs-12" style="padding: 5px;">
              <div class="pointer col-md-6 col-xs-6 tab-c tab-cat" style="padding: 0;border-bottom:1px solid white">Home</div>
              <div class="pointer col-md-6 col-xs-6 tab-c tab-home" style="padding: 0;">Posts</div>
            </div>
